            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-red">
                <div class="inner">
                  ...
                  $month = date('m');
                  $year=date('Y');
                  $sql6 = "SELECT * FROM customers WHERE MONTH(customers_renewal_date)=$month AND YEAR(customers_renewal_date)=$year AND customers_deleted='0'";
                  ...
                  echo "<h3>" . $query . "</h3>";
                  ?>
                  <div class="stat-panel-title text-uppercase">Total Renewal's</div>
                </div>
                <div class="icon">
                  <i class="fa fa-refresh"></i>
                </div>
                <a href="../renewal/" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
          <?php } ?>
          ...
          <?php if ($admin['customers_view']) { ?>
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-green">
                <div class="inner">
                  <?php
                  $sql6 = "SELECT customers_id from customers Where customers_deleted='0'";
                  $query6 = $conn->prepare($sql6);;
                  $query6->execute();
                  $results6 = $query6->fetchAll(PDO::FETCH_OBJ);
                  $query = $query6->rowCount();
                  echo "<h3>" . $query . "</h3>";
                  ?>
                  <div class="stat-panel-title text-uppercase">Total customers's</div>
                </div>
                <div class="icon">
